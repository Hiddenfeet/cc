:root {
  ...
  --colors-light-primary: #f7a104;
  --colors-light-primary0f: #f7a1040f;
  --colors-light-primary3D: #f7a1043D;
  --colors-light-primaryBright: #efac33;
  --colors-light-primaryDark: #d2a511;
  ...
  --colors-light-secondary: #5270f9;
  --colors-light-secondary80: #5270f980;
  ...
  --colors-light-textSubtle: #848a92;
  ...
  --colors-dark-primary: #f7a104;
  --colors-dark-primary0f: #f7a1040f;
  --colors-dark-primary3D: #f7a1043D;
  --colors-dark-primaryBright: #efac33;
  ...
  --colors-dark-secondary: #5270f9;
  --colors-dark-secondary80: #5270f980;
  --colors-dark-background: #08060B;
  --colors-dark-backgroundDisabled: #3c3742;
  --colors-dark-backgroundAlt: #0a1727;
  --colors-dark-backgroundAlt2: rgba(39, 38, 44, 0.7);
  --colors-dark-cardBorder: #162231;
  --colors-dark-contrast: #FFFFFF;
  --colors-dark-dropdown: #1E1D20;
  --colors-dark-dropdownDeep: #100C18;
  --colors-dark-invertedContrast: #000;
  --colors-dark-input: #00000077;
  --colors-dark-inputSecondary: #262130;
  --colors-dark-tertiary: #353547;
  --colors-dark-text: #F1F1F1;
  --colors-dark-text99: #848a9299;
  --colors-dark-textDisabled: #00000077;
  --colors-dark-textSubtle: #848a92;
  ...
  --colors-dark-gradientCardHeader: #121e2d;
  ...
  --shadows-focus: 0px 0px 0px 1px #F7A104, 0px 0px 0px 4px rgb(247,161,4, 0.2);
...
[data-theme="light"] {
  ...
  --colors-primary: #f7a104;
  --colors-primary0f: #f7a1040f;
  --colors-primary3D: #f7a1043D;
  --colors-primaryBright: #efac33;
  --colors-primaryDark: #d2a511;
  ...
  --colors-secondary: #5270f9;
  --colors-secondary80: #5270f980;
...
[data-theme="dark"] {
  ...
  --colors-gradientCardHeader: #121e2d;
